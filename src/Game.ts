...
if (map == 0) {
    ...
    const road2 = new Lane([intersect1, new RoadNode(100, 600)], 0.75, "blue");
    const road3 = new Lane([intersect2, new RoadNode(600, 1100)], 0.75, "blue");
    const road4 = new Lane([intersect3, new RoadNode(1100, 600)], 0.75, "blue");
    const road5 = new Lane([intersect4, new RoadNode(600, 100)], 0.75, "blue");
    ...
    const road6 = new Lane([intersect5, new RoadNode(1400, 600)], 0.75, "blue");
    const road7 = new Lane([intersect5, new RoadNode(1700, 900)], 0.75, "blue");
    const road8 = new Lane([intersect5, new RoadNode(2000, 600)], 0.75, "blue");
    const road9 = new Lane([intersect5, new RoadNode(1700, 300)], 0.75, "blue");
...
if (map == 1) {
    ...
    const road1 = new Lane([intersect1, new RoadNode(700, 300), new RoadNode(1100, 700), new RoadNode(1300, 900), new RoadNode(1300, 1000), intersect2, intersect1], 2, "blue")
    road1.roadEnd = road1;

    const road2 = new Lane([intersect2, new RoadNode(200, 1000), new RoadNode(200, 300), intersect1], 1, "red");
...
function gameLoop() {
    ...
    for (let trafficMap of trafficMaps) {
        ...
        // Draw roads
        for (let road of trafficMap.lanes) {
            context.beginPath();
